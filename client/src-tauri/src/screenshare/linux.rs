...
pub fn spawn_capture_task(
    ...
    loss_ms: Arc<AtomicU64>,
    video_tx: mpsc::Sender<Vec<u8>>,
    audio_tx: mpsc::Sender<Vec<u8>>,
    audio_enabled: Arc<AtomicBool>,
    audio_send_count: Arc<AtomicU32>,
    media_key: Arc<std::sync::Mutex<voipc_crypto::MediaKeyRing>>,
...
fn run_pipewire_capture(
    ...
    let processor = FrameProcessor {
        ...
        converter: None,
        frame_id: 0,
        keyframe_interval: voipc_video::KEYFRAME_INTERVAL_SECS * target_fps,
        start_time,
        target_width,
        target_height,
        active: active.clone(),
        keyframe_requested: keyframe_requested.clone(),
        loss_ms: loss_ms.clone(),
        base_bitrate_kbps: bitrate,
        base_fps: target_fps,
        level: 0,
        level_changed: Instant::now(),
        frame_counter: 0,
        video_tx,
        session_id,
